...
<div class="form-group">
                    <div class="input-group">
                     <span class="input-group-addon" style="background:#23374a;"><span class="glyphicon glyphicon-user" style="color:white;"></span></span>
                        ...
                        <input type="text" class="form-control" id="InputEmailFirst" name="uname" placeholder="Name" required>
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
    ...
    Photo <input type="file" name="uimg" id="img" accept="image/*" required>
                   ...
                   <div class="form-group">
                    <div class="input-group">
                       <span class="input-group-addon" style="background:#23374a;color:#FFFFFF;">Documents<!--<span class="glyphicon glyphicon-bookmark"></span>--></span>
                     <span class="btn btn-default btn-file">
   ...
   <section class="panel">
                    ...
                    <td class=" "><?php echo $i; ?></td>
                        ...
                        <td class="center hidden-phone  sorting_1"><a href="<?php echo $base; ?>Users/Update/<?php echo $us->id; ?>"  class="btn btn-primary" style="background:#23374a;">Edit</a></td>
                    </tr>
                    <?php
					$i++;
					}
