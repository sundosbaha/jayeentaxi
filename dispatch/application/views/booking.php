...
" id="routeForm" onSubmit=" return addbookingAjax(0)" method="post">
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon" style="background:#23374a;"><span class="glyphicon glyphicon-earphone" style="color:white;"></span></span>
                ...
                <div class="form-group col-md-6" style="padding:0;">
                    <div class="input-group">
                       <span class="input-group-addon" style="background:#23374a;"><span class="glyphicon glyphicon-map-marker" style="color:white;"></span></span>
                ...
                <div class="form-group col-md-6" style="padding:0;">
                    <div class="input-group">
                       <span class="input-group-addon" style="background:#23374a;"><span class="glyphicon glyphicon-flag" style="color:white;"></span></span>
             ...
             <!--   <div class="form-group">
                <label class="col-sm-5 control-label col-lg-5" for="inputSuccess">Vehicle Type</label>
                 ...
                 <div class="form-group">
                    <div class="input-group">
                       <span class="input-group-addon" style="background:#23374a;"><span class="glyphicon glyphicon-asterisk" style="color:white;"></span></span>
                   ...
                   <button style="background:#e03129;" type="submit" class="btn btn-primary" id="rideNowbutton" >Ride Now</button>
             <button style="background:#23374a;" type="button"  class="btn btn-primary" data-toggle="modal" data-target="#myModal" style="background: #1fb5ad;border: #1fb5ad;
