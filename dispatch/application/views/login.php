    ...
    <div class="col-md-4">
      <section class="login-form">
        ...
        <h3 class="text-center" style="color:#e03129;">Dispatcher</h3>
          <input type="text"  placeholder="UserName" name="username" required class="form-control input-lg" value="admin66" />
          
          <input type="password" class="form-control input-lg" id="password" name="password" placeholder="Password" required="" value="12345678" />
          ...
          <button type="submit" name="go" class="btn btn-lg btn-primary btn-block" style="background:#e03129; border-color: #e0711c;color: #fff;">Sign in</button>
          <div>
