...
" id="routeForm" onSubmit=" return addbookingAjax(0)" method="post">
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="customerMobile" id="customerMobile" placeholder="Número de teléfono" 
 title="Phone Number" required="" onChange="fetchcustomerDetails()">
                ...
                <div class="form-group">
                    <div class="input-group">
                     <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
                        <input type="text" class="form-control" id="customerfirstName" name="customerfirstName" placeholder="Nombre
" title="First Name" required="">
                ...
                <div class="form-group">
                    <div class="input-group">
                     <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
                        <input type="text" class="form-control" id="customerLastName" name="customerLastName" placeholder="Apellido
" required=""> 
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                       <span class="input-group-addon"><span class="glyphicon glyphicon-comment"></span></span>
                        <input type="text" class="form-control" id="customerAddress" name="customerAddress" placeholder="Dirección
" >
                ...
                <div class="form-group col-md-6" style="padding:0;">
                    <div class="input-group">
                       <span class="input-group-addon"><span class="glyphicon glyphicon-map-marker"></span></span>
                        <input type="text" class="form-control"  name="pickupLocation" placeholder="Origen" id="pickupLocation" required="">
                 ...
                 <div class="form-group col-md-6">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="pickupDetails" name="pickupDetails" placeholder="Origen detalles
" required="">
                ...
                <div class="form-group col-md-6" style="padding:0;">
                    <div class="input-group">
                       <span class="input-group-addon"><span class="glyphicon glyphicon-flag"></span></span>
                        <input type="text" class="form-control" id="dropoffLocation" name="dropoffLocation" placeholder="Destino
" required="">
                 ...
                 <div class="form-group col-md-6">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="dropoffDetails" name="dropoffDetails" placeholder="Destino detalles
" required="">
                ...
                <div class="form-group col-md-6" style="padding:0;">
                    <div class="input-group">
                       <span class="input-group-addon"><span class="glyphicon glyphicon-comment"></span></span>
                        <input type="text" class="form-control" id="numberOfadults" name="numberOfadults" placeholder="Numero de adultos
" required="">
                ...
                <div class="form-group col-md-6" style="padding:0;">
                    <div class="input-group">
                       <span class="input-group-addon"><span class="glyphicon glyphicon-comment"></span></span>
                        <input type="text" class="form-control" id="noOfchildren" name="noOfchildren" placeholder="Número de niños
" required="">
                    </div>
                </div>
             <!--   <div class="form-group">
                <label class="col-sm-5 control-label col-lg-5" for="inputSuccess">VEHÍCULOS
</label>
                   <div class="col-lg-6">
                    ...
                    <div class="input-group">
                       <span class="input-group-addon"><span class="glyphicon glyphicon-comment"></span></span>
                        <input type="text" class="form-control" id="luggageCount" name="luggageCount" placeholder="Equipajes
" required="">
                 ...
                 <div class="form-group">
                    <div class="input-group">
                       <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                        <textarea name="rideComment" placeholder="Comentario
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
							...
							$('#routeForm')[0].reset();
									...
									if(counterValue==20 &&  current_state == "0" )
									{
										clearInterval(cancelInterval);
										alert("No Drivers Found");
										counterValue=0;
...
function addbookingAjax(schedule=0)
{
	...
	console.log("The ajax URL is" +ajaxUrl);
var xhr =	$.ajax({
   url: ajaxUrl,
   data: {    
...
phone			:	'<?php echo $country_code ?>'+$('#customerMobile').val(),
password 		: 	makeid(),
...
dropoffLoc		:	$('#dropoffLocation').val(),
...
customerAddress :   $('#customerAddress').val(),
   ...
   beforeSend: function() {
	...
	{
		console.log('Inside Json object success check IF');
		console.log('JSON object success value'+jsonObj.success);
		console.log('JSON object request Id'+jsonObj.request_id);
		alert("No Driver Available at this time.");
		$('#overlay').toggle('display');
		$('#routeForm')[0].reset();
 ...
 console.log("The Ajax log is"+xhr);
marklocationinmap();
	return false;
}
