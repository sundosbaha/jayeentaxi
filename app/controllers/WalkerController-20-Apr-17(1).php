    ...
    public function register() {
        ...
        if ($validator->fails()) {
            ...
            if (Walker::where('email', '=', $email)->first()) {
                ...
                $walker->business_name=$business_name;
                $walker->business_address=$business_address;
                $walker->city = $city;
...
//                            exit;
                            ...
                            $request_data['charge_details'] = (!empty( $chagre ) ? $chagre : null);
                        ...
                        if ($request = Requests::find($request_id)) {
                            if ($request->confirmed_walker == $walker_id) {
                                ...
                                if ($request->is_started == 1) {
                                    ...
                                    $difference = isCheckDateDifferenceReturnMinutes($request->request_start_time);
