...
class AdminController extends BaseController {
    ...
    public function edit_walker() {
        ...
        $zoneTypes = DB::table('zone')->whereNull('deleted_at')->get();
        $success = Input::get('success');
...
";
	...
	public function privilege()
	{
		...
		$title = ucwords(trans('customize.privilege'));	
	...
	public function get_all_users() {
        ...
        $title = ucwords(trans('customize.privilege')); /* 'Promo Codes' */
    ...
    {
        $title = ucwords(trans('customize.zonedivision'));
    ...
    public function zonedivisions()
    {
        ...
        exit;*/
        $title = ucwords(Lang::get('customize.zonedivision')); /* 'Category' */
    ...
    public function provider_register_save()
    {
        ...
        Session::flash('message', 'Walker Successfully created!');
