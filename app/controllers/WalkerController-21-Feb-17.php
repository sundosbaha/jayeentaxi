                    ...
                    foreach ($request_data as $data) {
                        ...
                        if ($is_multiple_service->value == 0) {
                            ...
                            if ($setting_zone->value == 1) {
                                ...
                                $zoneTypesRecs = getTypeBesedZoneTyeRecords($requestserv->type);
                                $request['base_price'] = currency_converted($zoneTypesRecs[0]->base_price);
                                $request['distance_cost'] = currency_converted($zoneTypesRecs[0]->price_per_unit_distance);
                                $request['time_cost'] = currency_converted($zoneTypesRecs[0]->price_per_unit_time);
