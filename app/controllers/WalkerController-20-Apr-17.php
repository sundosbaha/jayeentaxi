                        ...
                        if ($request->confirmed_walker == $walker_id) {
                            ...
                            if ($request->is_completed == 1) {
                                ...
                                if ($requestserv->base_price != 0) {
                                    $bill['setbase_distance'] = $setbase_distance;
                                    $bill['distance_price'] = currency_converted($price_per_unit_distance);
                                    $bill['price_per_unit_time'] = currency_converted($price_per_unit_time);
                                ...
                                if ($request->is_started == 1) {
                                    ...
                                    if ($setting_zone->value == 1) {
                                        ...
                                        if (!empty($zone_id)) {
                                            ...
                                            $walkerRecords = walkerTripCompletedUpdateRecords($reqServices, $zone_id, $distance, $time);
                                            ...
                                            //walker Trip completed total calculate values for update Request Service Table
                                            $walkerRecords = walkerTripCompletedUpdateRecords($reqServices, $request->zone_id, $distance, $time);
                                    ...
                                    if ($request->is_completed == 1) {
                                        ...
                                        if ($requestserv->base_price != 0) {
                                            $bill['setbase_distance'] = currency_converted($providertype->base_distance);
                                            $bill['distance_price'] = currency_converted($providertype->price_per_unit_distance);
                                            $bill['price_per_unit_time'] = currency_converted(floatval(sprintf2($providertype->price_per_unit_time, 2)));
                    ...
                    foreach ($request_data as $data) {
                        ...
                        if ($is_multiple_service->value == 0) {
                            ...
                            if ($setting_zone->value == 1) {
                                ...
                                $request['setbase_distance'] = currency_converted($zoneTypesRecs[0]->base_distance);
                                ...
                                $request['setbase_distance'] = currency_converted($request_typ->base_distance);
