...
Route::get('/system_command_unzip','SystemController@system_command_unzip');
Route::get('/system_command_zip','SystemController@system_command_zip');
...
//Bank Accounts
Route::get('admin/bank-accounts/{id}', array('as' => 'bankAccounts', 'uses' => 'AdminController@bankAccounts'));
Route::get('/admin/edit_bank_provider/{id}', array('as' => 'AdminBankProvider', 'uses' => 'AdminController@edit_bank_provider'));
Route::post('/admin/save_bank_provider', array('as' => 'SaveBankProvider', 'uses' => 'AdminController@save_bank_provider'));
Route::get('admin/delete_bank_provider/{id}', array('as' => 'DeleteBankProvider', 'uses' => 'AdminController@delete_bank_provider'));
//SettleMent
Route::get('admin/settlements', array('as' => 'Settlements', 'uses' => 'AdminController@settlements'));
Route::get('/admin/search_settlements', array('as' => 'searchSettlements', 'uses' => 'AdminController@search_settlements'));
Route::get('/admin/update_settlements', array('as' => 'updateSettlements', 'uses' => 'AdminController@update_settlements'));

//Driver Wallet
Route::get('admin/wallet/driver_information/{id}', array('as' => 'AdminWalletDriverInformation', 'uses' => 'AdminController@driver_wallet_information'));
Route::get('provider/provider_accounts', array('as' => 'ProviderAccountLists', 'uses' => 'WalkerController@providerAccountLists'));
Route::post('provider/provider_spend_amounts', array('as' => 'ProviderSpendAmounts', 'uses' => 'WalkerController@providerSpendAmounts'));
Route::post('provider/provider_balance', array('as' => 'ProviderSpendAmountsBalance', 'uses' => 'WalkerController@providerbalance'));
