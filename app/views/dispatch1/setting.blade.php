...
@section('content')
    ...
    <div class="container-fluid">
        <div class="col-md-6 col-md-offset-3">
            ...
            <form action="" method="post" role="form" style="padding: 4px;border: 1px solid #C3C0C0;"
                  enctype="multipart/form-data">
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
                        <input type="text" class="form-control" id="InputEmailFirst" name="code"
                               placeholder="Country Code" value="<?php echo $setting->configValue; ?>" required>
                    </div>
                </div>
