...
<script
    src="https://maps.googleapis.com/maps/api/js?key=<?php echo Config::get('app.gcm_browser_key'); ?>&v=3.exp&sensor=false&libraries=places"></script>
...
<script type="text/javascript">
    ...
    function Legend(controlDiv, map) {
        ...
        controlText.innerHTML = '<span style="color:#7D7A75;"><b>Legends</b></span><br />' +

            '<img src="<?php echo asset_url(); ?>/image/driver_available.png" style="height:25px;"/> <span style="color:#7D7A75;">Available</span> </span><br />' +

            '<img src="<?php echo asset_url(); ?>/image/driver_on_trip.png" style="height:25px;"/><span style="color:#7D7A75;"> On a  <?= Config::get('app.generic_keywords.Trip') ?></span><br />';
