            ...
            <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="resp-full-td" valign="top" style="padding:20px; text-align:center;">
                        <span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff"><a href="#" style="color:#ffffff; outline:none; text-decoration:none;">{{ trans('email_translator.payment_done') }} {{ $mail_body['req_id'] }}</a></span>
                    </td>
                </tr>
                <!-- <tr>
                            ...
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:left;">
                                        {{ trans('email_translator.hello')}}, <strong style="font-weight: bold;">{{ $mail_body['name'] }}</strong>,
                                        <br>
                                        {{ trans('email_translator.your_payment')}} <?php /* echo "App Name"; */ echo ucwords(Config::get('app.website_title')); ?>   {{ trans('email_translator.is_done_of')}} <strong style="font-weight: bold;">{{ $mail_body['amount'] }}</strong> with <strong style="font-weight: bold;">{{ $mail_body['req_id'] }}</strong>.
                                        {{ trans('email_translator.please_do_share')}}
                                        <br>
                                        <br>
                                        {{ trans('email_translator.thanks')}},
                                        <br>
