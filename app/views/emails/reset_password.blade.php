            ...
            <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="resp-full-td" valign="top" style="padding:20px; text-align:center;">
                        <span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff"><a href="#" style="color:#ffffff; outline:none; text-decoration:none;">{{ trans('email_translator.password_reset') }}</a></span>
                    </td>
                </tr>
                <!-- <tr>
                        ...
                        <table width="100%" align="right" class="resp-full-table" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:center;">
                                        <strong style="font-weight: bold;">{{ trans('email_translator.congrats') }}</strong>
                                    </div>
                            ...
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:center;">
                                        {{ trans('email_translator.password_success_reset') }}
                                        <strong style="font-weight: bold;">{{ $mail_body['new_password'] }}</strong>. 
                                        <br>
                                       {{ trans('email_translator.please_dont_forgot_change') }}
                                    </div>
                                    <br>
                                    <!--  {{ $mail_body['login_url'] }} -->
                                    <div style="text-align:center"><a href="#" style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: <?php /* echo "App Name"; */ echo Config::get('app.email_color'); ?>;color:#fff;text-align:center;  text-decoration: none;">{{ trans('email_translator.login') }}</a></div>
                                    <br>
                                </td>
                            </tr>
                            <tr>
