            ...
            <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="resp-full-td" valign="top" style="padding:20px; text-align:center;">
                        <span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff"><a href="#" style="color:#ffffff; outline:none; text-decoration:none;">{{ trans('email_translator.ride_booking_request') }}</a></span>
                    </td>
                </tr>
                <!-- <tr>
                            ...
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:center;">
                                        {{ trans('email_translator.your_ride_request_id') }}
                                        <strong style="font-weight: bold;">{{ $mail_body['trip_id'] }}</strong>. 
                                       {{ trans('email_translator.follow_the_request_through') }}
                                        <!--  {{ $mail_body['follow_url'] }}   -->
                                        <a href="#" style="color:#545454; outline:none; text-decoration:none;"><strong style="font-weight: bold;"> URL </strong></a>. 
                                        <?php /* echo "App Name"; */echo ucwords(Config::get('app.website_title')); ?>
                                    </div>
                                    <br>
                                    <!-- {{ web_url() }}    -->
                                    <div style="text-align:center"><a href="#" style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: <?php /* echo "App Name"; */ echo Config::get('app.email_color'); ?>;color:#fff;text-align:center;  text-decoration: none;">{{ trans ('email_translator.follow') }}</a></div>
