                            ...
                            <table width="100%" align="right" class="resp-full-table" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                        ...
                                        <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:center;"> {{ trans('email_translator.you_request_password_reset') }} <?php echo $mail_body['password']; ?>. {{ trans('email_translator.please_dont_forgot_change') }}
                                        </div>
                                        <br><br>
                                        <!--  taxinow.xyz  -->
                                        <div style="text-align:center"><a href="<?php echo $mail_body['url']; ?>" style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: <?php /* echo "App Name"; */ echo Config::get('app.email_color'); ?>;color:#fff;text-align:center;  text-decoration: none;">{{ trans('email_translator.login') }}</a></div>
