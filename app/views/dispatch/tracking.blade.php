...
<div class="col-md-4" style="float:<?php echo $align_format; ?>"  dir="{{ trans('language_changer.text_format') }}">
...
" id="routeForm"  method="post">
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon" style="background:#23374a;"><span style="color:white;" class="glyphicon glyphicon-earphone"></span></span>
                        <input type="text" class="form-control" name="customerMobile" id="customerMobile" placeholder="<?php echo Lang::get('dispatcher.phonenumber'); ?>*" required="">
                       <input type="hidden" class="form-control" name="customerId" id="customerId" placeholder="Phone Number" >
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                     <span class="input-group-addon" style="background:#23374a;"><span style="color:white;" class="glyphicon glyphicon-user"></span></span>
                        <input type="text" class="form-control" id="customerfirstName" name="customerfirstName" placeholder="<?php echo Lang::get('dispatcher.fname'); ?>*" required="">
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                     <span class="input-group-addon" style="background:#23374a;"><span style="color:white;" class="glyphicon glyphicon-user"></span></span>
                        <input type="text" class="form-control" id="customerLastName" name="customerLastName" placeholder="<?php echo Lang::get('dispatcher.lname'); ?>*" required=""> 
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                       <span class="input-group-addon" style="background:#23374a;"><span style="color:white;" class="glyphicon glyphicon-comment"></span></span>
                        <input type="text" class="form-control" id="customerAddress" name="customerAddress" placeholder="<?php echo Lang::get('dispatcher.address'); ?>" >
                     
                    </div>
                </div>
            
                <div class="form-group col-md-8" style="padding:0;" style="float:<?php echo $align_format; ?>">
                    <div class="input-group">
                       <span class="input-group-addon" style="background:#23374a;"><span style="color:white;" id="pickup_in" class="glyphicon glyphicon-map-marker"></span></span>
                        <input type="text" class="form-control"  name="pickupLocation" placeholder="<?php echo Lang::get('dispatcher.Pickup'); ?>*" id="pickupLocation" required="">
                 ...
                 <div class="form-group col-md-4">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="pickupDetails" name="pickupDetails" placeholder="<?php echo Lang::get('dispatcher.Pickdetails'); ?>" required="">
                     
                    </div>
                </div>
                <div class="form-group col-md-8" style="padding:0;" dir="{{ trans('language_changer.text_format') }}">
                    <div class="input-group">
                       <span class="input-group-addon" style="background:#23374a;"><span style="color:white;" id="drop_in" class="glyphicon glyphicon-flag"></span></span>
                        <input type="text" class="form-control" id="dropoffLocation" name="dropoffLocation" placeholder="<?php echo Lang::get('dispatcher.drop'); ?>*" required="">
                 ...
                 <div class="form-group col-md-4">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="dropoffDetails" name="dropoffDetails" placeholder="<?php echo Lang::get('dispatcher.dropdetail'); ?>" required="">
                ...
                <div class="form-group col-md-6" style="padding:0;">
                    <div class="input-group">
                       <span class="input-group-addon" style="background:#23374a;"><span style="color:white;" class="glyphicon glyphicon-comment"></span></span>
                        <input type="text" class="form-control" id="numberOfadults" name="numberOfadults" maxlength="1" placeholder="<?php echo Lang::get('dispatcher.no_of_adult'); ?>" required="">
                ...
                <div class="form-group col-md-6" style="padding:0;">
                    <div class="input-group">
                       <span class="input-group-addon" style="background:#23374a;"><span style="color:white;" class="glyphicon glyphicon-comment"></span></span>
                        <input type="text" class="form-control" id="noOfchildren" name="noOfchildren" maxlength="1" placeholder="<?php echo Lang::get('dispatcher.no_of_child'); ?>" required="">
                    </div>
                </div>
             <!--   <div class="form-group">
                <label class="col-sm-5 control-label col-lg-5" for="inputSuccess">Vehicle Type</label>
                   <div class="col-lg-6">
                    ...
                    <div class="input-group">
                       <span class="input-group-addon" style="background:#23374a;"><span style="color:white;" class="glyphicon glyphicon-comment"></span></span>
                        <input type="text" class="form-control" id="luggageCount" name="luggageCount"  placeholder="<?php echo Lang::get('dispatcher.luggages'); ?>" required="">
                ...
                <div class="col-md-6 form-group" id="price_d">
                 ...
                 <div class="form-group">
                    <div class="input-group">
                       <span class="input-group-addon" style="background:#23374a;"><span style="color:white;" class="glyphicon glyphicon-asterisk"></span></span>
                        <textarea name="rideComment" placeholder="<?php echo Lang::get('dispatcher.comment'); ?>" id="rideComment" class="form-control" rows="1" required></textarea>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
                    ...
                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                        <input type="text" class="form-control" id="booking_date_picker" placeholder="<?php echo Lang::get('dispatcher.booking_date'); ?>" required="" name="booking_time_picker">        
                    </div>
                </div>
...
//$('#rideNowbutton').click(function(e) {
	function create_trip(){
		...
		$.ajax({
				...
				data:{"phone":phone_num,"user_id":user_id,"fname":fname,"lname":lname,"address":address,"pick_location":pick_location,"pick_lati":pick_lati,"pick_longi":pick_longi,"pick_detail":pick_detail,"drop_location":drop_location,"drop_lati":drop_lati,"drop_longi":drop_longi,"drop_detail":drop_detail,"type":type,"adult":adult,"child":child,"ridecomment":ridecomment,"luggage":luggage},
				async:true,
				...
				if(response_user.success)
		    {
				...
				data:{"request_id":response_user.request_id,"driver_id":sel[0],"user_id":user_id},
				async:true,
				beforeSend: function(dat)
				{
					$('body').removeClass('loaded');
...
function addbookingAjax(schedule=0)
{
   ...
   data:{"user_timezone":getTimeZone(),"schedule":scheduleDateTime,"phone":phone_num,"user_id":user_id,"fname":fname,"lname":lname,"address":address,"pick_location":pick_location,"pick_lati":pick_lati,"pick_longi":pick_longi,"pick_detail":pick_detail,"drop_location":drop_location,"drop_lati":drop_lati,"drop_longi":drop_longi,"drop_detail":drop_detail,"type":type,"adult":adult,"child":child,"ridecomment":ridecomment,"luggage":luggage},
   error: function(a,b,c) {
      console.log(a);
	  console.log(b);
	  console.log(c);
