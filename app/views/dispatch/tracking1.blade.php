...
" id="routeForm" method="post">
            ...
            <div class="form-group col-md-8" style="padding:0;">
                <div class="input-group">
                    <span class="input-group-addon"><span id="pickup_in" class="glyphicon glyphicon-map-marker"></span></span>
            ...
            <div class="form-group col-md-8" style="padding:0;">
                <div class="input-group">
                    <span class="input-group-addon"><span id="drop_in" class="glyphicon glyphicon-flag"></span></span>
            ...
            <button type="button" class="btn btn-primary" style="background: #1fb5ad;border: #1fb5ad;
" onClick="valid()"><?php echo Lang::get('dispatcher.ride_late'); ?>

            </button>
        <!--<button type="button"  class="btn btn-primary"  id="estimate" style="background: #a2b51f;border: #5b6807;
    ...
    <script>
        ...
        function init(lati, longi) {
            ...
            autocomplete_drop.addListener('place_changed', function () {
                ...
                drop_window = true;
                estimate(directionsService, directionsDisplay);
            });
                ...
                if (type != '') {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            type_driver_update(map, type);
                            if (driver_type_update) {
                                clearTimeout(driver_type_update);
                            }
        ...
        function type_driver_update(map, type) {
            $.ajax({
                type: "post",
                url: "{{ URL::Route('DispatchProviderXml') }}",
                data: "type=" + type,
                success: function (data) {
                    ...
                    markersArray = newmarkersArray;
                    newmarkersArray = [];
                    driver_type_update = setTimeout(function () {
                        type_driver_update(map, type);
                    }, 5000);
                },
                error: function (a, b, c) {
        ...
        function estimate(directionsService, directionsDisplay) {
                ...
                directionsService.route({
                    ...
                    if (status == 'OK') {
                        ...
                        $.ajax({
                            type: "post",
                            url: "{{ URL::Route('Dispatcheta') }}",
                            data: "type=" + type + "&distance=" + dis + "&duration=" + dur,
                            success: function (data) {
                                console.log(data);
