...
<div class="box box-success">
    ...
    <div class="col-md-8" dir="{{ trans('language_changer.text_format') }}" style="float:<?php echo $align_format; ?>"  >

        <input type="text" class="form-control" id="my-address" placeholder="{{ trans('language_changer.please_enter_your_address') }}">

    </div>



    <div class="col-md-4" id="flow2" dir="{{ trans('language_changer.text_format') }}"  >

        <button id="getCords" class="btn btn-success" onClick="codeAddress();">{{ trans('language_changer.find_location') }}</button>
...
<script src="https://maps.googleapis.com/maps/api/js?key=<?php echo Config::get('app.gcm_browser_key'); ?>&v=3.exp&sensor=false&libraries=places"></script>
...
if(parseInt(markers[i].getAttribute("lat")) != 0 || parseInt(markers[i].getAttribute("lat")) != 0)
{
										...
										if(type == 'driver_on_trip' || type == 'driver_free')
										{
                        ...
                        zoom: 3
								...
								var pos1 = new google.maps.LatLng(35.480993,
            ...
            function Legend(controlDiv, map) {
                ...
                controlText.innerHTML = '<span style="color:#7D7A75;"  ><b><?= trans('language_changer.legends') ?></b></span><br />' +

                        '<img src="<?php echo asset_url(); ?>/image/driver_available.png"   style="height:25px;"/> <span style="color:#7D7A75;"><?= trans('language_changer.available') ?></span> </span><br />' +

                        '<img src="<?php echo asset_url(); ?>/image/driver_on_trip.png" dir="" style="height:25px;"/><span style="color:#7D7A75; "><?= trans('language_changer.on_a_trip') ?></span><br />'
