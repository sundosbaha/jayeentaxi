           ...
           <div class="form-group">
                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>             
                            <td>
                                <input class="form-control" name="type[{{$type->id}}]" id="type[{{$type->id}}]" type="text" placeholder="Type" value="{{$type->name}}" disabled><br>
                            </td>
                            <td>
                                <?php $counter++; ?>
                                <span id="no_amount_error<?php echo $counter; ?>" style="display: none"></span>
                                <input class="form-control" name="service_base_price[{{$type->id}}]" id="service_base_price[{{$type->id}}]" type="text" onkeypress="return Isamount(event,<?php echo $counter; ?>);" value="" placeholder="{{ trans('customize.base_price') }}" ><br>
                            ...
                            <td>
                                <?php $counter++; ?>
                                <span id="no_amount_error<?php echo $counter; ?>" style="display: none"></span>
                                <input class="form-control" name="service_price_distance[{{$type->id}}]" id="service_price_distance[{{$type->id}}]" type="text" onkeypress="return Isamount(event,<?php echo $counter; ?>);" value="" placeholder="{{ trans('customize.price_per_unit_distance') }}" ><br>
                            ...
                            <td>
                                <?php $counter++; ?>
                                <span id="no_amount_error<?php echo $counter; ?>" style="display: none"></span>
                                <input class="form-control" name="service_price_time[{{$type->id}}]" id="service_price_time[{{$type->id}}]" type="text" onkeypress="return Isamount(event,<?php echo $counter; ?>);" value="" placeholder="{{ trans('customize.price_per_unit_time') }}" ><br>
                            ...
                            <td>
                                <?php $counter++; ?>
                                <span id="no_amount_error<?php echo $counter; ?>" style="display: none"></span>
                                <input class="form-control" name="service_max_size[{{$type->id}}]" id="service_max_size[{{$type->id}}]" type="text" onkeypress="return Isamount(event,<?php echo $counter; ?>);" value="" placeholder="{{ trans('customize.max_size') }}" ><br>
                            ...
                            <td>
                                <?php $counter++; ?>
                                <span id="no_amount_error<?php echo $counter; ?>" style="display: none"></span>
                                <input class="form-control" name="service_visible[{{$type->id}}]" id="service_visible[{{$type->id}}]" type="checkbox" onkeypress="return Isamount(event,<?php echo $counter; ?>);" value="yes" checked><br>
                            </td>
                        </tr>
                        <?php $count++; ?>
                        @endforeach
