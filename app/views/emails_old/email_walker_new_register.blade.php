            ...
            <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="resp-full-td" valign="top" style="padding:20px; text-align:center;">
                        <span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff"><a href="#" style="color:#ffffff; outline:none; text-decoration:none;">Welcome to <?php /* echo "App Name"; */ echo ucwords(Config::get('app.website_title')) ?>, {{ $mail_body['name'] }}</a> </span>
                    </td>
                </tr>
                <!-- <tr>
                        ...
                        <table width="100%" align="right" class="resp-full-table" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    <div style="padding: 10px;font-size:22px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;color: <?php /* echo "App Name"; */ echo Config::get('app.email_color'); ?>;text-align:center;">Thanks for signing up! We're excited to have you join us and start providing service.
                                    </div>
