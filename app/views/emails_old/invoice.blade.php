<html>
    ...
    <body style="margin: 0px; padding: 0px; border: 0px;font-family: sans-serif;">
        <!--main div-->
        <div style="margin: 0px auto;width: 90%; padding: 15px;background-color: <?php /* echo "App Name"; */ echo Config::get('app.email_color'); ?>;color: #FFFFFF;">
            <!-- logo -->            
            <div>
            ...
            <div style="background-color: #FFFFFF;">
                ...
                <div style="padding: 1.5em;color: #000000;">
                    <div style="background-color: #f3f3f3;border: 2px solid #c3c3c3;border-radius: 5px;width: 100%;float: left;">
                ...
                <div style="padding: 15px 0px 0px 0px;color: #ffffff;background-color: <?php /* echo "App Name"; */ echo Config::get('app.email_color'); ?>">
                    <div style="margin: 15px 25px 15px 0;width: 50px;width: 48%;float: left; border-right: 1px solid rgba(255,255,255,.2);">
                        ...
                        <p style="float: right;margin: 5px 0 0 5px;padding: 0px;width: 81%;">
                            <span style="color: #fff;font-size: 12px;font-weight: bold;"><?= Config::get('app.website_title') ?> Support</span>
                            <br/>
                            <span style="font-size: 12px;"><a href="#" style="color: #FFFFFF;">Contact us</a> with questions about your trip.
                                <br/>
                                Leave something behind? <a href="#" style="color: #FFFFFF;">Track it down.</a></span>
                        </p>
                        <h1 style="clear: both;"></h1>
                    </div>
