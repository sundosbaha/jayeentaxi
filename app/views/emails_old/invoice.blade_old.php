        ...
        <td>
            <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0" style="padding:20px;">
                ...
                <td width="100%">
                    ...
                    <table width="300" align="left" class="resp-full-table" style="margin:0 auto;float:none;background-color:<?php /* echo "App Name"; */ echo Config::get('app.email_color'); ?>; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                    ...
                    <table width="100%" align="right" class="resp-full-table" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                <div style="background:<?php /* echo "App Name"; */ echo Config::get('app.email_color'); ?>;padding: 10px;font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff">TOTAL<span style="float:right;"><?php echo /* $currency->keyword */Config::get('app.generic_keywords.Currency') . ' ' . $email_data['total']; ?></span></div>
                            </td>
                        </tr>
