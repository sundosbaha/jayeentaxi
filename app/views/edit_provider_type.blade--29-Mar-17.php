...
<div class="box box-primary">
    ...
    <form method="post" id="basic" action="{{ URL::Route('AdminProviderTypeUpdate') }}" enctype="multipart/form-data">
        ...
        <div class="form-group col-md-12 col-sm-12">
            ...
            <input type="text" class="form-control" name="name" placeholder="Type Name" name="name"
                   value="<?= $name ?>">
            {{--@if ($errors->has('name'))
        ...
        <div class="form-group col-md-6 col-sm-6">
            ...
            <input type="text" class="form-control" onkeypress="return Isamount(event, 1);" placeholder="Base Price"
                   name="base_price" value="<?= $base_price ?>">
        </div>
        <div class="form-group col-md-6 col-sm-6">
            <label>Price Per Unit Distance (in US Dollar)</label> <span id="no_amount_error2"
                                                                        style="display: none"> </span>
            <input type="text" class="form-control" onkeypress="return Isamount(event, 2);"
                   placeholder="Price Per Unit Distance" name="distance_price" value="<?= $price_per_unit_distance ?>">
        </div>
        <div class="form-group col-md-6 col-sm-6">
            <label>Price Per Unit Time (in US Dollar)</label> <span id="no_amount_error3" style="display: none"> </span>
            <input type="text" class="form-control" onkeypress="return Isamount(event, 3);"
                   placeholder="Price Per Unit Time" name="time_price" value="<?= $price_per_unit_time ?>">
        </div>
        <div class="form-group col-md-6 col-sm-6">
            <label>Maximum Size</label> <span id="no_number_error1" style="display: none"> </span>
            <input type="text" class="form-control" onkeypress="return IsNumeric(event, 1);" placeholder="Maximum Size"
