...
<a id="addtype" href="{{ URL::Route('AdminProviderTypeEdit', 0) }}">
    <button type="submit" class="btn btn-flat btn-block btn-success" id="drivetype" value="">Add New {{
        trans('customize.Provider');}} Type
    </button>
</a>
            ...
            <div class="box-body row">
                ...
                <div class="col-md-6 col-sm-12">
                    <select class="form-control" id="sortdrop" name="type">
                        ...
                        ?> id="provid">{{ trans('customize.Provider');}} Type ID
                        </option>
                        <option value="pvname" <?php
                        if (isset($_GET['type']) && $_GET['type'] == 'pvname') {
                            echo 'selected="selected"';
                        }
                        ?> id="pvname">{{ trans('customize.Provider');}} Name
                        </option>
                    </select>
                    <br>
                </div>
            ...
            <tr>
                ...
                <td><?= $type->name ?>
                    <?php if ($type->is_default) { ?>
                        <font style="color:rgb(15, 131, 15);">(Default)</font>
                    <?php } ?>
                </td>
                ...
                <td>
                    <a href="{{ URL::Route('AdminProviderTypeEdit', $type->id) }}"><input type="button"
