                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                ...
                                <?php } ?>
                                  ...
                                  <?php if ($walker->is_available == 1) { ?>
                                    <li role="presentation"><a role="menuitem" id="Available" tabindex="-1" href="{{ URL::Route('AdminProviderAvailable', $walker->id) }}">Unavailable</a></li>
                                <?php } ?>
