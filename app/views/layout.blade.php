...
<html>
    ...
    <head>
        ...
        <title><?= $title ?> | <?= Config::get('app.website_title') ?> {{ trans('lanuage_changer.web_dash_board') }}</title>
...
?>
                        ...
                        <li class="dropdown user user-menu" dir="{{ trans('language_changer.text_format'); }}">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <i class="glyphicon glyphicon-user"  ></i>
                                <span >{{trans('language_changer.Admin'); }}</span>
                            </a>
                            ...
                            <ul class="dropdown-menu">
                              ...
                              <?php if(!inarray('AdminAdmins', $urll)) {?>
                                <li class="user-body" dir="{{ trans('language_changer.text_format'); }}">
                                    <div class="col-xs-12 text-center">
                                        <a href="{{ URL::Route('AdminAdmins') }}">{{trans('language_changer.admin_control') }}</a>
                                    </div>
                                    <?php } ?>

                                </li>
                                <!-- Menu Footer-->
                                <li class="user-footer" dir="{{ trans('language_changer.text_format'); }}">
                                    <div class="col-md-12">
                                        <a class="btn btn-default btn-flat btn-block" href="{{ URL::Route('AdminLogout') }}">{{trans('language_changer.log_out'); }}</a>
                                    </div>
                ...
                <a target="_blank" dir="{{ trans('language_changer.text_format'); }}" href="<?php $link=str_replace('public','',url());  echo $link."public/dispatch/login"; ?>" class="btn btn-primary btn-sm gradient" style="float:right;margin-right: 50px;margin-top: 10px;">{{trans('language_changer.dispatcher'); }}</a>
            </nav>
        </header>
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    <ul class="sidebar-menu">
                        ...
                        <li id="dashboard" title="Dashboard" dir="{{ trans('language_changer.text_format'); }}" >
                       ...
                       <?php if(!inarray('AdminMapview', $urll)) {?>
                        ...
                        <li id="map-view" title="Map View" dir="{{ trans('language_changer.text_format'); }}" >
                        ...
                        <li id="walkers" title="Providers" dir="{{ trans('language_changer.text_format'); }}">
                        ...
                        <li id="walks" title="Requests" dir="{{ trans('language_changer.text_format'); }}">
                        ...
                        <li id="owners" title="Users" dir="{{ trans('language_changer.text_format'); }}">
                            <a href="{{ URL::Route('AdminUsers') }}"><i class="fa fa-users"></i> <span>{{ trans('customize.User').'s'; }}</span></a>
                        </li>
                         <?php } ?>

                        <?php if(!inarray('AdminReviews', $urll)) {?>
                        <li id="reviews" title="Reviews" dir="{{ trans('language_changer.text_format'); }}">
                        ...
                        <!--<li id="information" title="Information" dir="{{ trans('language_changer.text_format'); }}">
                        ...
                        <li id="provider-type" title="Provider Types" dir="{{ trans('language_changer.text_format'); }}">
                       ...
                       <!-- <li id="document-type" title="Provider Types" dir="{{ trans('language_changer.text_format'); }}">
                        ...
                        <li id="promo_code" title="Promo Code" dir="{{ trans('language_changer.text_format'); }}">
                    ...
                    <li id="keywords" title="Kewords" dir="{{ trans('language_changer.text_format'); }}">
                        ...
                        <li id="payments" title="Payment Details" dir="{{ trans('language_changer.text_format'); }}">
                        ...
                        <li id="settings" title="Setings" dir="{{ trans('language_changer.text_format'); }}">
                        ...
                        <li id="privilege" title="Dashboard" dir="{{ trans('language_changer.text_format'); }}">
                         ...
                         <?php } ?>
                            ...
                            <li id="zonedivision" title="Zone Division" dir="{{ trans('language_changer.text_format'); }}">
...
<?php } elseif( trans('language_changer.text_format') == 'rtl' ){ ?>
        <div class="wrapper row-offcanvas row-offcanvas-left" >
            ...
            <aside class="right-side">
                ...
                <section class="content-header" dir="{{ trans('language_changer.text_format') }}">
<?php
