...
<a id="adddoc" href="{{ URL::Route('AdminDocumentTypesEdit', 0) }}">
    <button type="submit" class="btn btn-flat btn-block btn-success" id="newdoc" value="Add New Document Type">Add New
        Document Type
    </button>
</a>
    ...
    <table class="table table-bordered">
        ...
        <?php foreach ($types as $type) { ?>
            <tr>
                ...
                <td><a id="edit" href="{{ URL::Route('AdminDocumentTypesEdit', $type->id) }}"><input type="button"
