                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-push-2 clearfix">
                            <div class="section-heading scrollpoint sp-effect3">
                                ...
                                <span class="divider"></span>
                                <p>And when you have the itch to contact us, we are right here at info@nplustechnologies.com Shoot a mail and we would solve your queries.</p>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="social">
                            ...
                            <p class="rights">
                                2015 <span><?= Config::get('app.website_title') ?></span>  | <a href="{{route('termsncondition')}}"><span>Terms and Conditions</span></a>
                            </p>
                        </div>
                    </div>
                </div>
